  ...
  return (
    <div className='bg-white cursor-pointer w-56 h-60 rounded-lg' >
        <figure className='relative mb-2 w-full h-4/5' >
            ...
            <img  className='w-full h-full object-cover rounded-lg' src='https://images.pexels.com/photos/5877672/pexels-photo-5877672.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1' alt='Headphones' />
